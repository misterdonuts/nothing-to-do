...
InvitationRelation.create(status: 0, user_id: 1, sender_id:2, invitation_id: 1)
InvitationRelation.create(status: 0, user_id: 3, sender_id:2, invitation_id: 1)
InvitationRelation.create(status: 0, user_id: 4, sender_id:2, invitation_id: 1)
InvitationRelation.create(status: 0, user_id: 2, sender_id:1, invitation_id: 2)
InvitationRelation.create(status: 0, user_id: 3, sender_id:2, invitation_id: 2)
InvitationRelation.create(status: 0, user_id: 1, sender_id:3, invitation_id: 3)
InvitationRelation.create(status: 0, user_id: 4, sender_id:3, invitation_id: 3)
InvitationRelation.create(status: 0, user_id: 5, sender_id:3, invitation_id: 3)
