...
class GroupInvitationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create group_invitation' do
    assert_difference('GroupInvitation.count') do
      post group_invitations_url, params: { group_invitation: { group_id: @group_invitation.group_id, sender_id: @group_invitation.sender_id, status: @group_invitation.status, user_id: @group_invitation.user_id } }
    end
  ...
  test 'should update group_invitation' do
    patch group_invitation_url(@group_invitation), params: { group_invitation: { group_id: @group_invitation.group_id, sender_id: @group_invitation.sender_id, status: @group_invitation.status, user_id: @group_invitation.user_id } }
