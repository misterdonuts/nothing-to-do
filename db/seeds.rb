...
User.create(email: 'three@gmail.com', 	user_name: '三郎', invite_num: 99, 	be_invited_num: 19932, 	accept_num: 1999, 	password:'foobar', password_confirmation: 'foobar', account_name: 'three', 	is_free: 1)
