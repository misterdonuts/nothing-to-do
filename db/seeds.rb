...
User.create(email: 'four@gmail.com', 	user_name: '士郎', invite_num: 6, be_invited_num: 10, accept_num: 50, password:'foobar', password_confirmation: 'foobar')
User.create(email: 'five@gmail.com', 	user_name: '五郎', invite_num: 100, be_invited_num: 10, accept_num: 80, password:'foobar', password_confirmation: 'foobar')
User.create(email: 'six@gmail.com', 	user_name: '六郎', invite_num: 100, be_invited_num: 10, accept_num: 80, password:'foobar', password_confirmation: 'foobar')
User.create(email: 'seven@gmail.com', 	user_name: '七郎', invite_num: 100, be_invited_num: 10, accept_num: 80, password:'foobar', password_confirmation: 'foobar')
User.create(email: 'eight@gmail.com', 	user_name: '八郎', invite_num: 100, be_invited_num: 10, accept_num: 80, password:'foobar', password_confirmation: 'foobar')
User.create(email: 'nine@gmail.com', 	user_name: '苦郎', invite_num: 100, be_invited_num: 10, accept_num: 80, password:'foobar', password_confirmation: 'foobar')
User.create(email: 'ten@gmail.com', 	user_name: '10浪', invite_num: 100, be_invited_num: 10, accept_num: 80, password:'foobar', password_confirmation: 'foobar')
