...
User.create(email: 'one@gmail.com', 	user_name: '一郎', invite_num: 6, 	be_invited_num: 100, 	accept_num: 50, password:'foobar', password_confirmation: 'foobar')
User.create(email: 'two@gmail.com', 	user_name: '次郎', invite_num: 1, 	be_invited_num: 100, 	accept_num: 100, password:'foobar', password_confirmation: 'foobar')
User.create(email: 'three@gmail.com', 	user_name: '三郎', invite_num: 99, 	be_invited_num: 19932, 	accept_num: 1999, password:'foobar', password_confirmation: 'foobar')
User.create(email: 'four@gmail.com', 	user_name: '士郎', invite_num: 6, 	be_invited_num: 100, 	accept_num: 50, password:'foobar', password_confirmation: 'foobar')
User.create(email: 'five@gmail.com', 	user_name: '五郎', invite_num: 100, be_invited_num: 100, 	accept_num: 80, password:'foobar', password_confirmation: 'foobar')
User.create(email: 'six@gmail.com', 	user_name: '六郎', invite_num: 100, be_invited_num: 100, 	accept_num: 80, password:'foobar', password_confirmation: 'foobar')
User.create(email: 'seven@gmail.com', 	user_name: '七郎', invite_num: 100, be_invited_num: 100, 	accept_num: 80, password:'foobar', password_confirmation: 'foobar')
User.create(email: 'eight@gmail.com', 	user_name: '八郎', invite_num: 100, be_invited_num: 100, 	accept_num: 80, password:'foobar', password_confirmation: 'foobar')
User.create(email: 'nine@gmail.com', 	user_name: '苦郎', invite_num: 100, be_invited_num: 100, 	accept_num: 80, password:'foobar', password_confirmation: 'foobar')
User.create(email: 'ten@gmail.com', 	user_name: '10浪', invite_num: 100, be_invited_num: 100, 	accept_num: 80, password:'foobar', password_confirmation: 'foobar')
