...
InvitationRelation.create(status: 0, sender_id: 2, user_id:3, invitation_id: 1)
InvitationRelation.create(status: 0, sender_id: 2, user_id:4, invitation_id: 1)
InvitationRelation.create(status: 0, sender_id: 3, user_id:1, invitation_id: 2)
InvitationRelation.create(status: 0, sender_id: 3, user_id:2, invitation_id: 2)
InvitationRelation.create(status: 0, sender_id: 3, user_id:4, invitation_id: 2)
